...
public class totalWage {
	...
	public totalWage(String company, int wage_per_hour,int days_worked,int hours_worked){
...
public static void main(String[] args) {
	totalWage ibm=new totalWage("IBM", 30, 22, 120);
 ibm.computeWage();
 totalWage ibm2=new totalWage("IBM2", 40, 20, 120);
 ibm2.computeWage();
 totalWage ibm3=new totalWage("IBM3", 35, 25, 125);
 ibm3.computeWage();
}
